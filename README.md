...
DB_CONFIG = {
    "dbname":   os.getenv("DB_NAME",     "VoiceAndroid"),
...
| `RECORD_AUDIO permission denied` on Android | Grant in device Settings → Apps → VoiceAndroid |
