...
CREATE DATABASE VoiceAndroid;
CREATE USER VoiceAndroid_user WITH ENCRYPTED PASSWORD 'VoiceAndroid_pass';
GRANT ALL PRIVILEGES ON DATABASE VoiceAndroid TO VoiceAndroid_user;

\connect VoiceAndroid
...
GRANT ALL PRIVILEGES ON ALL TABLES    IN SCHEMA public TO VoiceAndroid_user;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO VoiceAndroid_user;
