...
SELECT 'CREATE DATABASE VoiceAndroid OWNER voiceuser'
WHERE NOT EXISTS (
    SELECT FROM pg_database WHERE datname = 'VoiceAndroid'
)\gexec
...
GRANT ALL PRIVILEGES ON DATABASE VoiceAndroid TO voiceuser;
